...
NOT_PARSING_URLS = ['tatar', 'kodms.ru', 'mos-sud.ru', 'mirsud.spb.ru', 'mirsud.sev.gov.ru/', 'mirsud24.ru', 'mirsud86.ru/', 'mirsud-chr.ru', 'stavmirsud.ru', 'mirsud.e-mordovia.ru', 'mirsud.pskov.ru', 'mirsud82.rk.gov.ru', 'lipetsk']
...
CODES = ['АПК', 'ВК', 'ГК', 'ГПК', 'ЖК', 'ЗК', 'КАС', 'КоАП', 'СК', 'ТК', 'УИК', 'УПК', 'УК', 'ЗИО']

REGIONS_URL_CODES = {'alt': 'Алтайский край', 'amr': 'Амурская область', 'arh': 'Архангельская область',
                     ...
                     'krs': 'Курская область', 'lo': 'Ленинградская область', 'lipetsk': 'Липецкая область', 'lpk': 'Липецкая область',
...
CSV_TITLES = ["Номер дела", "Время слушания", "Событие", "Информация по делу", "Судья", "Участок", "Город", "Регион",
              "Подраздел", "Дата", "URL дела", "Результат слушания", "URL страницы", "Номер статьи", "Кодекс", "ФИО",
              "Фамилия Имя", "Имя Отчество", "Фамилия", "Имя", "Отчество", "ФИО и номер дела", "ФИО и дата дела",
              "ФИО и область", "Дата сборки", "Количеством дней"]

FORMS = ['ИП ', 'ООО ', 'АО ', 'ПАО ', 'КО ', 'ПК ', 'ГУП ', 'МУП ', 'Ф ', 'НП ', 'СПК ', 'ОП ', 'ХТ ', 'ПО ',
         'УП ', 'ФКУ ', 'ОМВД ', 'ГКУ ', 'Прокуратура', 'ТФОМС', 'Город', 'Област', 'Район', ' ПАО', 'Банк ']
REPL_WORDS = ['ОТВЕТЧИК', 'ИСТЕЦ', 'ВЗЫСКАТЕЛЬ', 'ДОЛЖНИК', 'ЗАЯВИТЕЛЬ', 'ПРАВОНАРУШЕНИЕ', 'ПОДСУДИМЫЙ',
              'ТРЕТЬИ ЛИЦА']